...
(
    ...
    `company_id`     INT             NOT NULL    COMMENT '렌탈회사 아이디', 
    PRIMARY KEY (id)
);
...
ALTER TABLE user_details
    ADD CONSTRAINT FK_user_details_users_id FOREIGN KEY (id)
...
(
    ...
    `brand`  VARCHAR(100)    NOT NULL    COMMENT '차량명', 
    `model`  VARCHAR(100)    NOT NULL    COMMENT '브랜드', 
    PRIMARY KEY (id)
);
/*
+-------+--------------+------+-----+---------+----------------+
...
| car_number      | varchar(100)  | NO   |     | NULL              |                   |
| phone_number    | varchar(100)  | NO   |     | NULL              |                   |
| state           | varchar(100)  | NO   |     | NULL              |                   |
| city            | varchar(100)  | NO   |     | NULL              |                   |
| additional_info | varchar(1000) | YES  |     | NULL              |                   |
| drive_date      | timestamp     | YES  |     | NULL              |                   |
| checkout_date   | timestamp     | YES  |     | NULL              |                   |
| status          | int           | NO   |     | 0                 |                   |
| created_at      | timestamp     | NO   |     | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
| removed_at      | timestamp     | YES  |     | NULL              |                   |
+-----------------+---------------+------+-----+-------------------+-------------------+
...
+-----------------+---------------+------+-----+-------------------+-------------------+
| id              | int           | NO   | PRI | NULL              | auto_increment    |
| first_car_id    | int           | NO   | MUL | NULL              |                   |
| second_car_id   | int           | YES  | MUL | NULL              |                   |
| additional_info | varchar(1000) | YES  |     | NULL              |                   |
